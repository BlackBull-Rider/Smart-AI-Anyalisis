...
REQUIRED_FEATURES = (
    ...
    "absorption_candle", "rejection_candle",
...
PCT_KEYS = {
    "fii": (
        "fii_holding_pct",
        "fii_holding_percentage",
        "fpi_holding_pct",
        "fpi_holding_percentage",
    ),
    "dii": (
        "dii_holding_pct",
        "dii_holding_percentage",
    ),
    "inst": (
...
def _lr(weight: float) -> float:
    return _clip(
        math.exp(_clip(weight, -1.9, 2.08)),
        MIN_LR,
        MAX_LR,
    )
...
class InstitutionalAnalyzer:
        ...
        try:
            ...
            if current_market is None:
                ...
                result["institutional_analyzer"]["evidence"].append(
                    self._evidence(
                        "Institutional",
                        "No valid market data snapshot found in payload.",
                        0.99,
                        0.35,
                    )
                )
            ...
            prom_pct, prom_delta = self._extract_value_and_delta(
                rows,
                "promoter",
            )
                ...
                if abs(prom_delta) < 0.01:
                    ...
                    nodes.append(
                        EvidenceNode(
                            ...
                            1.0,
                            1.0,
                            "Promoter holding remains structurally stable.",
                            0.85,
                        )
                    )
            ...
            pledge_pct, pledge_delta = self._extract_value_and_delta(
                rows,
                "pledge",
            )
            ...
            if pledge_pct is not None and pledge_pct > 15.0:
                ...
                nodes.append(
                    EvidenceNode(
                        ...
                        magnitude,
                        1.2,
                        f"Significant promoter pledge "
                        f"({pledge_pct:.1f}%) acts as corporate overhang.",
                        0.90,
                    )
                )
            ...
            if pledge_delta is not None and abs(pledge_delta) > 0.05:
                ...
                nodes.append(
                    EvidenceNode(
                        ...
                        magnitude,
                        1.5,
                        f"Promoter pledge {action} by "
                        f"{abs(pledge_delta):.2f}%.",
                        0.90,
                    )
                )
            ...
            inst_pct, inst_delta = self._extract_value_and_delta(
                rows,
                "inst",
            )

            fii_pct, fii_delta = self._extract_value_and_delta(
                rows,
                "fii",
            )

            dii_pct, dii_delta = self._extract_value_and_delta(
                rows,
                "dii",
            )
            ...
            has_inst_data = (
                inst_pct is not None
                or fii_pct is not None
                or dii_pct is not None
                or inst_delta_found
            )
                ...
                if abs(combined_inst_delta) < 0.02:
                    ...
                    nodes.append(
                        EvidenceNode(
                            ...
                            1.0,
                            1.0,
                            "Institutional ownership structure remains largely stable.",
                            0.85,
                        )
                    )
                    ...
                    direction = (
                        1.0
                        if combined_inst_delta > 0
                        else -1.0
                    )

                    magnitude = _clip(
                        abs(combined_inst_delta) / 1.5,
                        0.1,
                        1.0,
                    )
                    ...
                    nodes.append(
                        EvidenceNode(
                            ...
                            magnitude,
                            1.6,
                            f"Institutional ownership {action} by "
                            f"{abs(combined_inst_delta):.2f}%.",
                            0.92,
                        )
                    )
            ...
            delivery_pct, _ = self._extract_value_and_delta(
                rows,
                "delivery",
            )
                ...
                if delivery_pct > 50.0:
                    ...
                    if p_dir > 0:
                        ...
                        nodes.append(
                            EvidenceNode(
                                ...
                                magnitude,
                                1.0,
                                f"High delivery ({delivery_pct:.1f}%) "
                                "validates upside price accumulation.",
                                0.88,
                            )
                        )
                        ...
                        nodes.append(
                            EvidenceNode(
                                ...
                                1.0,
                                f"High delivery ({delivery_pct:.1f}%) "
                                "validates downside price distribution.",
                                0.88,
                            )
                        )
                    ...
                    nodes.append(
                        EvidenceNode(
                            ...
                            0.5,
                            0.8,
                            f"Low delivery ({delivery_pct:.1f}%) "
                            "implies largely speculative volume.",
                            0.80,
                        )
                    )
            ...
            if vol_magnitude > 0 and p_dir != 0:
                ...
                nodes.append(
                    EvidenceNode(
                        ...
                        vol_magnitude,
                        1.3,
                        "Significant volume expansion confirms current directional pressure.",
                        0.85,
                    )
                )
            ...
            if (
                ...
                nodes.append(
                    EvidenceNode(
                        ...
                        0.8,
                        1.5,
                        "Candle footprint matches institutional block execution.",
                        0.85,
                    )
                )
            ...
            if absorption == 1.0 and micro_dir != 0:
                ...
                nodes.append(
                    EvidenceNode(
                        ...
                        0.7,
                        1.4,
                        f"Absorption pattern suggests consumption "
                        f"of opposing {action_str}.",
                        0.82,
                    )
                )
            ...
            if liq_sweep == 1.0 and micro_dir != 0:
                ...
                nodes.append(
                    EvidenceNode(
                        ...
                        0.75,
                        1.6,
                        "Liquidity sweep indicates trapping of retail participants.",
                        0.85,
                    )
                )
            ...
            if rejection == 1.0 and micro_dir != 0:
                ...
                nodes.append(
                    EvidenceNode(
                        ...
                        0.6,
                        1.2,
                        "Strong rejection confirms boundary defense.",
                        0.80,
                    )
                )
            ...
            if precalc_acc is not None and precalc_acc > 0.5:
                ...
                nodes.append(
                    EvidenceNode(
                        ...
                        precalc_acc,
                        1.0,
                        "Underlying algorithmic structure signals accumulation bias.",
                        0.80,
                    )
                )
            ...
            if precalc_dist is not None and precalc_dist > 0.5:
                ...
                nodes.append(
                    EvidenceNode(
                        ...
                        precalc_dist,
                        1.0,
                        "Underlying algorithmic structure signals distribution bias.",
                        0.80,
                    )
                )
            ...
            ownership_stability = _clip(
                100.0 - variance_penalty,
                0.0,
                100.0,
            )
            ...
            promoter_score = _clip(
                sum(
                    n.magnitude * 100.0
                    for n in nodes
                    if n.domain == "promoter"
                ),
                0.0,
                100.0,
            )
            ...
            del_status = (
                "high"
                if delivery_val > 55.0
                else "low"
                if (
                    delivery_val > 0
                    and delivery_val < 35.0
                )
                else "neutral"
            )
            ...
            if (
                ...
                evidence_output.append(
                    self._evidence(
                        "Institutional",
                        "Severe contradiction between aggressive buying "
                        "and selling signals creates a high-churn/neutral state.",
                        0.95,
                        0.8,
                    )
                )
            ...
            if (
                prom_pct is not None
                or prom_delta is not None
            ):
                coverage_domains += 1

            if (
                inst_delta_found
                or inst_pct is not None
            ):
                coverage_domains += 1
            ...
            if (
                smc is not None
                or liq_sweep is not None
            ):
                coverage_domains += 1

            coverage_ratio = (
                coverage_domains / 5.0
            )
            ...
            return {
                "institutional_analyzer": {
                    ...
                    "institutional_buying": _safe_float(
                        round(inst_buying, 4)
                    ),
                    "institutional_selling": _safe_float(
                        round(inst_selling, 4)
                    ),
                    "promoter_confidence": _safe_float(
                        round(promoter_conf, 4)
                    ),
                    "ownership_stability": _safe_float(
                        round(ownership_stability, 4)
                    ),
                    "accumulation": _safe_float(
                        round(acc_score, 4)
                    ),
                    "accumulation_status": acc_status,
                    "distribution": _safe_float(
                        round(dist_score, 4)
                    ),
                    "distribution_status": dist_status,
                    "institutional": _safe_float(
                        round(inst_score, 4)
                    ),
                    "institutional_status": inst_status,
                    "promoter": _safe_float(
                        round(promoter_score, 4)
                    ),
                    "promoter_status": prom_status,
                    "delivery": _safe_float(
                        round(delivery_val, 4)
                    ),
                    "delivery_status": del_status,
                    "shareholding": _safe_float(
                        round(shareholding_quality, 4)
                    ),
            ...
            self.logger.exception(
                f"Institutional Analyzer Critical Failure: {e}"
            )
            ...
            result[
                ...
                self._evidence(
                    "Institutional",
                    "Execution encountered a critical failure.",
                    0.96,
                    0.42,
                )
            )
    ...
    def _extract_value_and_delta(
        ...
        pct_names = PCT_KEYS.get(
            domain,
            (),
        )

        chg_names = CHG_KEYS.get(
            domain,
            (),
        )
...
def analyze(
    ...
    **kwargs: Any,
    ...
    return InstitutionalAnalyzer().analyze(
        data,
        *args,
        **kwargs,
    )
