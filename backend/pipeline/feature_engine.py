"""
GREEN BULL AI
Feature Engine (Restored from Original Reliable Indicator Engine)
"""
import pandas as pd
import warnings
...
def run(symbol: str, df: pd.DataFrame) -> pd.DataFrame:
    ...
    # ওভারল্যাপ (Overlap) এড়ানোর জন্য আপনার অরিজিনাল কোডে একটু সেফগার্ড যুক্ত করা হলো
    ...
    features["SR_DONCHIAN_UPPER"] = dc_sr["upper"]
    features["SR_DONCHIAN_MIDDLE"] = dc_sr["middle"]
    features["SR_DONCHIAN_LOWER"] = dc_sr["lower"]
